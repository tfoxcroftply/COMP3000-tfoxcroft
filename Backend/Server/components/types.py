...
class _Config: # temporary config location, might make a dedicated file for it
    usb_port: str = "COM4" # let host_info handle in future for environment changes
    ...
    debug_node_count: int = 3 # amount of nodes to create with database with debug mode active
